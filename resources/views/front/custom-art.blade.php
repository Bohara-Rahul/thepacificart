    ...
    <section class="container p-5 mt-16">
        ...
        <article class="flex gap-10 mt-10">
            <aside class="flex flex-col justify-center  p-20">
                ...
                <ul>
                    <li><p><span class="text-lg">Personalized Designs:</span> Our artists work closely with you to understand your style,
                        preferences, and the atmosphere you want to create.</li></p><br />
                    <li><span class="text-lg">Perfect Fit:</span> No matter the size, color palette, or theme, we design art that fits
                        your
                        space seamlessly.</li><br />
                    <li><span class="text-lg">Quality Craftsmanship:</span> We pride ourselves on using premium materials and techniques
                        to
                        deliver exceptional, one-of-a-kind artwork that elevates your space.</li><br />
                    <li><span class="text-lg">Global Inspiration:</span> With artists from around the world, we bring diverse cultural
        ...
        <section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 place-content-center gap-5">
                <article class="bg-gray-100 shadow-md p-5">
                    <p class="text-[#3d6571]"><span class="text-3xl">1.</span> <strong class="font-mono text-2xl">Consultation:</strong></p>
                    <p>
                        Share your ideas, inspirations, and the specifics of your space (dimensions, colors, and mood).
                    </p>
                </article>
                <article class="bg-gray-100 shadow-md p-5">
                    <p class="text-[#3d6571]"><span class="text-3xl">2.</span> <strong class="font-mono text-2xl">Design & Concept:</strong></p>
                    <p>
                        Our artists will create a draft based on your input and send it for your approval.
                    </p>
                </article>
                <article class="bg-gray-100 shadow-md p-5">
                    <p class="text-[#3d6571]"><span class="text-3xl">3.</span> <strong class="font-mono text-2xl">Creation:</strong></p>
                    <p>
                        Once you’re happy with the design, we begin crafting your custom piece.
                    </p>
                </article>
                <article class="bg-gray-100 shadow-md p-5">
                    <p class="text-[#3d6571]"><span class="text-3xl">4.</span> <strong class="font-mono text-2xl">Delivery:</strong></p>
                    <p>
