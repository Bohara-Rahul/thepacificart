        ...
        <div class="grid grid-cols-2 mt-10 gap-5">
            ...
            <article class="flex flex-col justify-center">
                ...
                <div class="flex flex-col gap-2 text-center">
                    <a href="{{ route('front.wishlist', $product->id) }}" class="border border-gray-500 hover:bg-gray-200 p-1">
                        <button>
                            Add to Wishlist
                        </button>
                    </a>
                    <a href="{{ route('front.wishlist', $product->id) }}" class="btn btn-secondary">
                    <button>
                        Add to cart
                    </button>
                    </a>
                    <a href="{{ route('front.wishlist', $product->id) }}" class="btn btn-primary">
