                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('uploads/' . $category->thumbnail) }}" class="w-5 h-5" />
                            </td>
                            <td>{{ $category->title }}</td>
                            <td>{{ $category->slug }}</td>
                            <td>
                                <a class="btn btn-secondary"
                                    href="{{ route('admin_categories_edit', $category->id) }}">Edit</a>
                                <a href="{{ route('admin_categories_delete', $category->id) }}"
